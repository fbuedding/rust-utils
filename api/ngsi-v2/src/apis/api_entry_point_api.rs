...
/// struct for typed errors of method [`retrieve_api_resources`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RetrieveApiResourcesError {
...
pub async fn retrieve_api_resources(configuration: &configuration::Configuration, ) -> Result<crate::models::RetrieveApiResourcesResponse, Error<RetrieveApiResourcesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveApiResourcesError> = serde_json::from_str(&local_var_content).ok();
