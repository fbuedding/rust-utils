...
impl ListRegistrationsResponse {
    pub fn new(id: String, description: String, data_provided: serde_json::Value, provider: serde_json::Value, expires: String, status: String, forwarding_information: serde_json::Value) -> ListRegistrationsResponse {
